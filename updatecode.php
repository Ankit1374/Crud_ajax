<?php
    ...
    $error_status= 0;
        ...
        if(empty($_FILES['photo']['name']))
        {
            ...
            $photo = input_data($_POST['prev_photo']);
        }else{
        ...
        if($error_status== 1){
            ...
            $query = "UPDATE records SET emp='$emp', fname='$fname', lname='$lname', dept='$dept', contact=' $contact', photo='$photo', desg='$desg', salary='$salary' WHERE id='$e_id'  ";
